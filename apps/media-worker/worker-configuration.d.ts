/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml` (hash: ce97e483fbc3c8050f11f4d26ec4b268)
// Runtime types generated with workerd@1.20260611.1 2026-06-17 
interface __BaseEnv_Env {
	AIRING_CAL_KV: KVNamespace;
	AIRING_CAL_R2: R2Bucket;
	AIRING_CAL_D1: D1Database;
	SUBJECT_REFRESH_COORDINATOR: DurableObjectNamespace<import("./src/index").SubjectRefreshCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SubjectRefreshCoordinator";
	}
