/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml` (hash: 452a909f61d6797911f62e561898c2e4)
// Runtime types generated with workerd@1.20260611.1 2026-06-17 
interface __BaseEnv_Env {
	AIRING_CAL_KV: KVNamespace;
	AIRING_CAL_DATA_R2: R2Bucket;
	AIRING_CAL_D1: D1Database;
	MEDIA_QUEUE: Queue;
	SYNC_MODE: "merge";
	SNAPSHOT_COORDINATOR: DurableObjectNamespace<import("./src/production").SnapshotCoordinator>;
	SYNC_WORKFLOW: Workflow<Parameters<import("./src/production").SyncWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/production");
		durableNamespaces: "SnapshotCoordinator";
	}
