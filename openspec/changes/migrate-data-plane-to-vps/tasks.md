...
- [ ] 2.3 Implement optional fail-open Sentry tracing for the VPS run and coordinator stages with disabled-by-default, redaction, exactly-once, and bounded-flush RED-to-GREEN tests
