...
- [x] 1.3 删除 sessionStorage Token 持久化并在页面初始化清除历史 `sync-tokenA/B`
- [x] 1.4 增加 CSP、nosniff、frame/base 限制并验证 JSON operation check 契约不变
...
- [x] 3.4 增加单/双账户无效 Token compare RED 测试，返回稳定非 200 认证错误
