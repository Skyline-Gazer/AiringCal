...
- Stage: `sixth-extra-fix-authorized`
...
- Next action: add legacy/expired confirmed tombstone plus 403 regression, stop all post-reprobe image work while metadata remains confirmed, then obtain independent review.
